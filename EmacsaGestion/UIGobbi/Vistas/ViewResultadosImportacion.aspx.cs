...
public partial class Vistas_ViewResultadosImportacion : GobbiPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            Ajax.Utility.RegisterTypeForAjax(typeof(Vistas_ViewResultadosImportacion));
    ...
    protected void GvResultados_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Select") {
            Response.Redirect("ViewDetalleUltimaImportacionCliente.aspx?idCliente=" + this.GvResultados.Rows[int.Parse(e.CommandArgument.ToString())].Cells[1].Text);
        }
