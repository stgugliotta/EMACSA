...
public partial class Vistas_ViewDetalleUltimaImportacionClientePreview : GobbiPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            Ajax.Utility.RegisterTypeForAjax(typeof(Vistas_ViewDetalleUltimaImportacionClientePreview));
    ...
    private DataTable GetDataTableUltimaImportacionClienteErrorSigno()
    {
        ...
        List<InterfazFacturaDataContracts> listaIFDto = interfazFacturaService.GetAllInterfazFacturasByClienteFechaProcesoPreview(Int32.Parse(this.idcli.Value), this.fechaProceso);
    ...
    private DataTable GetDataTableUltimaImportacionFacturasBajaPorInterfaz()
    {
        ...
        List<InterfazFacturaDataContracts> listaIFDto = interfazFacturaService.GetAllFacturasBajaPorInterfazByClienteFechaProcesoPreview(Int32.Parse(this.idcli.Value), this.fechaProceso);
    ...
    {
        Response.Redirect("ViewResultadosImportacionPreviewMaster.aspx");
    }
}
