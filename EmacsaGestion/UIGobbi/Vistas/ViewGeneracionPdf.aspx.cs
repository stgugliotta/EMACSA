    ...
    private void CreaarPdf(int idRemision)
    {
        ...
        try
        {
            ...
            foreach (ReciboDataContracts oRecibo in lstRecibo)
            {
                ...
                string pszNombreDeudor = "\nCliente:                 " + oRecibo.Deudor.Nombre + "           (" + oRecibo.Deudor.IdDeudor.ToString() + ")\n";
                iTextSharp.text.Chunk chnkNombreDeudor = new iTextSharp.text.Chunk(pszNombreDeudor, fTimes);
                iTextSharp.text.Phrase obPhraseDeudor = new iTextSharp.text.Phrase();
                obPhraseDeudor.Add(chnkNombreDeudor);
                oDoc.Add(obPhraseDeudor);
                ...
                foreach (ReciboPagoDataContracts oReciboPago in lstReciboPagos)
                {
                    ...
                    switch (unPago.FormaPago.Descripcion)
                    {
                        case "CHEQUE":
                            ...
                            unPago.IdPago = int.Parse(oCheque.Numero.ToString());
                            break;
                        case "EFECTIVO":
                        ...
                        case "RETENCION":
                            ...
                            unPago.IdMoneda = oReciboPago.IdMoneda;
                            unPago.TotalPesificado = oReciboPago.TotalPesificado;
                            unPago.IdPago =int.Parse(oRetencion.NumeroRetencion.ToString());
                            break;
                        case "DEPOSITO":
                            ...
                            unPago.IdMoneda = oReciboPago.IdMoneda;
                            unPago.TotalPesificado = oReciboPago.TotalPesificado;
                            unPago.IdPago = int.Parse(oDeposito.NumComprobante.ToString());
                            break;
                        case "TRANSFERENCIA":
                            ...
                            unPago.IdMoneda = oReciboPago.IdMoneda;
                            unPago.TotalPesificado = oReciboPago.TotalPesificado;
                            unPago.IdPago = int.Parse(oTransferencia.NumComprobante.ToString());
                            break;
                        case "OTRO":
                            ...
                            unPago.IdMoneda = oReciboPago.IdMoneda;
                            unPago.TotalPesificado = oReciboPago.TotalPesificado;
                            unPago.IdPago = int.Parse(oOtroPago.NumComprobante.ToString());
                            break;
                        case "DESCUENTO":
                            ...
                            unPago.IdMoneda = oReciboPago.IdMoneda;
                            unPago.TotalPesificado = oReciboPago.TotalPesificado;
                            unPago.IdPago = int.Parse(oDescuento.NumComprobante.ToString());
                            break;
                    }
                    #endregion
                    lstPagos.Add(unPago);
