...
public partial class Vistas_ViewExportToExcelHDR : GobbiPage 
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            HojaDeRutaExcelDataContracts hr = (HojaDeRutaExcelDataContracts)Session["CACHE_HOJADERUTA_A_EXPORTAR"];
            System.IO.File.Delete(Server.MapPath("Files\\HojaDeRuta.xls"));

            if (hr != null)
            {

                ExcelXmlWriter.ExcelExport.Generate(Server.MapPath(".") + "\\Files\\HojaDeRuta.xls", hr);
