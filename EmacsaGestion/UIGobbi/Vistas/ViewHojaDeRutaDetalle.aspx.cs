...
public partial class Vistas_ViewHojaDeRutaDetalle : GobbiPage 
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            Ajax.Utility.RegisterTypeForAjax(typeof(Vistas_ViewHojaDeRutaDetalle));

            this.cmbZona.Items.Clear();
