                                                                                    ...
                                                                                    <ajaxToolkit:TabContainer runat="server" ID="TabContainer1" Height="337px" Width="310px"
                                                                                               ...
                                                                                               <td align="left" style="width:195px;">
                                                                                                ...
                                                                                                <td align="left"><asp:Label ID="lblCheque" runat="server" Style="font-family: Verdana; font-size: 9px;"
                                                                                                                ...
                                                                                                                ValidationGroup="chequeGroup" Width="83px" TabIndex="12" onkeypress="return runScript(event)"></asp:TextBox><ajaxToolkit:CalendarExtender
                                                                                                                    ...
                                                                                                                    <asp:RequiredFieldValidator runat="server" ControlToValidate="txtFechaEmision" ErrorMessage="*" ValidationGroup="chequeGroup"></asp:RequiredFieldValidator>
                                                                                        ...
                                                                                        <ajaxToolkit:TabPanel runat="server" ID="TabPanel1" HeaderText="Retencion" Enabled="true"
                                                                                            Visible="true"><HeaderTemplate>Reten</HeaderTemplate><ContentTemplate><asp:UpdatePanel runat="server" ID="UpdatePanelSubtipoRetencion" UpdateMode="Conditional"><ContentTemplate><table style="margin-top: 15px;"><tr><td align="left"><asp:Label ID="lblSubtipoRetencion" runat="server" Style="font-family: Verdana; font-size: 9px;"
                                                                                                                        ...
                                                                                                                        <asp:RegularExpressionValidator ControlToValidate="txtFechaRetencion" runat="server" ValidationExpression="(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d" ErrorMessage="*" ValidationGroup="retencionesGroup"></asp:RegularExpressionValidator>
                                                                                                                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txtFechaRetencion" ErrorMessage="*" ValidationGroup="retencionesGroup"></asp:RequiredFieldValidator>
                                                                                        ...
                                                                                        <ajaxToolkit:TabPanel runat="server" ID="TabPanel4" HeaderText="Deposito" Enabled="true"
                                                                                            Visible="true"><HeaderTemplate>Dep</HeaderTemplate><ContentTemplate><table style="margin-top: 15px;"><tr><td align="left"><asp:Label ID="lblCuentaDeudor" runat="server" Style="font-family: Verdana; font-size: 9px;"
                                                                                                                ...
                                                                                                                TabIndex="43" ValidationGroup="depositosGroup" Width="83px"></asp:TextBox><ajaxToolkit:CalendarExtender
                                                                                                                    ...
                                                                                                                    PopupButtonID="ImgFechaDeposito" TargetControlID="txtFechaDeposito"></ajaxToolkit:CalendarExtender>
                                                                                                                
                                                                                                                <asp:RegularExpressionValidator ControlToValidate="txtFechaDeposito" runat="server" ValidationExpression="(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d" ErrorMessage="*" ValidationGroup="depositosGroup"></asp:RegularExpressionValidator>
                                                                                                                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtFechaDeposito" ErrorMessage="*" ValidationGroup="depositosGroup"></asp:RequiredFieldValidator>
                                                                                                                    
                                                                                                                
                                                                                                                <asp:ImageButton ID="ImgFechaDeposito" runat="server"
                                                                                        ...
                                                                                        <ajaxToolkit:TabPanel runat="server" ID="TabPanel5" HeaderText="Transferencia" Enabled="true"
                                                                                            Visible="true"><HeaderTemplate>Transf</HeaderTemplate><ContentTemplate><table style="margin-top: 15px;"><tr><td align="left"><asp:Label ID="lblCuentaCredito" runat="server" Style="font-family: Verdana; font-size: 9px;"
                                                                                                                ...
                                                                                                                font-size: 9px;" Text="Fecha Depósito"></asp:Label></td><td>
                                                                                                                <asp:TextBox ID="txtFechaTransferencia" runat="server" CssClass="textboxEditor" Height="16px"
                                                                                                                TabIndex="52" ValidationGroup="transferenciasGroup" Width="83px"></asp:TextBox>
                                                                                                                <ajaxToolkit:CalendarExtender
                                                                                                                    ID="CalendarExtenderFechaTrans" runat="server" Enabled="True" Format="dd/MM/yyyy"
                                                                                                                    PopupButtonID="ImgFechaTransf" TargetControlID="txtFechaTransferencia"></ajaxToolkit:CalendarExtender>
                                                                                                                
                                                                                                                <asp:RegularExpressionValidator ControlToValidate="txtFechaTransferencia" runat="server" ValidationExpression="(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d" ErrorMessage="*" ValidationGroup="transferenciasGroup"></asp:RegularExpressionValidator>
                                                                                                                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtFechaTransferencia" ErrorMessage="*" ValidationGroup="transferenciasGroup"></asp:RequiredFieldValidator>
    
                                                                                                                <asp:ImageButton ID="ImgFechaTransf" runat="server"
                                                                                        ...
                                                                                        <ajaxToolkit:TabPanel runat="server" ID="TabPanel6" HeaderText="OtrosPagos" Enabled="true"
                                                                                            Visible="true"><HeaderTemplate>Otros</HeaderTemplate><ContentTemplate><table style="margin-top: 15px;"><tr><td align="left"><asp:Label ID="lblTipoPagoRaro" runat="server" Style="font-family: Verdana; font-size: 9px;"
                                                                                                                ...
                                                                                                                Text="Fecha Pago"></asp:Label></td><td>
                                                                                                                <asp:TextBox ID="txtFechaPagoRaro" runat="server" CssClass="textboxEditor" Height="16px"
                                                                                                                TabIndex="61" ValidationGroup="otrosPagosGroup" Width="83px"></asp:TextBox>
                                                                                                                <ajaxToolkit:CalendarExtender
                                                                                                                    ID="CalendarExtenderOtros" runat="server" Enabled="True" Format="dd/MM/yyyy"
                                                                                                                    PopupButtonID="ImgFechaRara" TargetControlID="txtFechaPagoRaro"></ajaxToolkit:CalendarExtender>
                                                                                                                    
                                                                                                                <asp:RegularExpressionValidator ControlToValidate="txtFechaPagoRaro" runat="server" ValidationExpression="(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d" ErrorMessage="*" ValidationGroup="otrosPagosGroup"></asp:RegularExpressionValidator>
                                                                                                                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtFechaPagoRaro" ErrorMessage="*" ValidationGroup="otrosPagosGroup"></asp:RequiredFieldValidator>
                                                                                                                    
                                                                                                                
                                                                                                                <asp:ImageButton ID="ImgFechaRara" runat="server"
