...
public partial class Vistas_ViewResultadosImportacionMaster : GobbiPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            Ajax.Utility.RegisterTypeForAjax(typeof(Vistas_ViewResultadosImportacionMaster));
            ...
            //this.GvResultados.DataSource = this.GetDataTableImportaciones();
    ...
    private DataTable GetDataTableImportacionesPorFecha()
    {
        ...
        List<ImportacionFacturaDataContracts> listaImportacionFac = ImportadorInterfaces.mostrarResultadosPorFecha(DateTime.Parse( this.txtFechaDesde.Text));
    ...
    protected void GvResultados_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Select") {
            Response.Redirect("ViewDetalleUltimaImportacionCliente.aspx?idCliente=" + this.GvResultados.Rows[int.Parse(e.CommandArgument.ToString())].Cells[1].Text + "&fechaProceso=" +this.GvResultados.Rows[int.Parse(e.CommandArgument.ToString())].Cells[9].Text);
        }
