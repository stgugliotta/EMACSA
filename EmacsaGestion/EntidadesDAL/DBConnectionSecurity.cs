...
namespace EntidadesDAL
{
    ...
    /// </summary>
    public class DBConnectionSecurity
    {
        ...
        /// </summary>
        private static DBConnectionSecurity instancia;
        ...
        public static DBConnectionSecurity Instancia
        {
            get
            {
                lock (lockObject)
                {
                   ////if (_instancia.Db == null) // || (_instancia.ObjConnection == null) || (_instancia.ObjConnection.ConnectionString == string.Empty))
                    //// {
                        instancia = new DBConnectionSecurity();
                        instancia.Db = DatabaseFactory.CreateDatabase("EvaSecurityDatabase");
