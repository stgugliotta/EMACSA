...
namespace ar.com.telecom.eva.services
{
    ///<summary>
    ...
    {           
        ...
        /// y otras tareas.
        /// </summary>
        /// <exception cref="EvaFunctionalException">Representa errores inesperados del código, o fallas en dispositivos o entidades externas</exception>
        /// <exception cref="EvaTechnicalException">Representa a los errores funcionales de los servicios, es decir, los errores que están directamente relacionados con la lógica de negocio.</exception>
        ...
        public static T GetService(string serviceName)
        {
            ...
            catch (EvaFunctionalException e)
            {
                throw e;
            }
            catch (Exception e)
            {
                throw new EvaTechnicalException("",e);
            }
        }
