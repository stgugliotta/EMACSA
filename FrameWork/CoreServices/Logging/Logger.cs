...
namespace Gobbi.CoreServices.Logging
{
    ...
    public static class Logger
    {
        ...
        {
            if (log == null)
                 throw new GobbiTechnicalException ("", new ArgumentNullException("log"));
        ...
        public static void WriteSync(LogEntry log)
        {
            if (log == null)
                throw new GobbiTechnicalException("", new ArgumentNullException("log"));
        ...
        private static LogEntry CreateLogEntry(string title, string message, string category)
        {
            if (string.IsNullOrEmpty(title))
                 throw new GobbiTechnicalException ("", new   ArgumentNullException("title"));
            if (string.IsNullOrEmpty(message))
                 throw new GobbiTechnicalException ("", new   ArgumentNullException("message"));
