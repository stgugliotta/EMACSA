    ...
    public class FileConfigurationSource : IConfigurationSource
    {
        ...
        public void Init(ConfigurationSourceElement configurationElement)
        {
            ...
            if(string.IsNullOrEmpty(fileName))
               throw new GobbiTechnicalException ("", new ConfigurationErrorsException(Resources.ERROR_FILECONFIGURATIONSOURCE_FILENAME_NOTSPECIFIEDINCONFIGURATION));
            if(!File.Exists(fileName))
                throw new GobbiTechnicalException ("", new FileNotFoundException(string.Format(Resources.ERROR_FILECONFIGURATIONSOURCE_FILENOTFOUND, fileName), fileName));
