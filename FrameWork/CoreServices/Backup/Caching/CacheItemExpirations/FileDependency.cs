...
namespace ar.com.telecom.eva.CoreServices.Caching.CacheItemExpirations
{
    ...
    public class FileDependency : ICacheItemExpiration
    {
        ...
        public FileDependency(string fullFileName)
        {
            ...
            {
                throw new EvaTechnicalException("", new  ArgumentException(Resources.ERROR_NULLFILENAME, "fullFileName"));
            }
            ...
            {
                throw new EvaTechnicalException("", new  ArgumentException(string.Format(Resources.ERROR_INVALIDFILENAME, fullFileName), "fullFileName"));
            }
