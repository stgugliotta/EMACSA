    ...
    public class SQLConfigurationSource : IConfigurationSource
    {
        ...
        public void Init(ConfigurationSourceElement configurationElement)
        {
            ...
            if(string.IsNullOrEmpty(catalogName))
                throw new EvaTechnicalException ("", new  ConfigurationErrorsException(Resources.ERROR_SQLCONFIGURATIONSOURCE_CATALOGNAMENOTSPECIFIED));

            ConnectionStringSettings connectionStringSettings = 
                System.Configuration.ConfigurationManager.ConnectionStrings[catalogName];

            if(connectionStringSettings == null)
                throw new EvaTechnicalException ("", new ConfigurationErrorsException(string.Format(Resources.ERROR_SQLCONFIGURATIONSOURCE_CATALOGNAMENOTFOUND, catalogName)));
