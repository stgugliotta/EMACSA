...
using System.Text;
using ar.com.telecom.eva.CoreServices.Data.Databases;
...
namespace ar.com.telecom.eva.CoreServices.Data
{
    ...
    public static class DatabaseFactory
    {
        ...
        public static Database CreateDatabase()
        {
            ...
            if (section == null)
                throw new EvaTechnicalException ("", new System.Configuration.ConfigurationErrorsException("Falta la sección de configuración."));
        ...
        private static System.Configuration.ConnectionStringsSection GetConnectionStringsConfiguration()
        {
            if (!connConfigPedida)
            {
                ...
                connConfiguration = (System.Configuration.ConnectionStringsSection)ar.com.telecom.eva.CoreServices.Configuration.ConfigurationManager.GetSection(Constants.ConnectionStringsSectionName);
            }
        ...
        private static DataConfigurationSection GetDataConfiguration()
        {
            if (!dataConfigPedida)
            {
                ...
                dataConfiguration = (DataConfigurationSection)ar.com.telecom.eva.CoreServices.Configuration.ConfigurationManager.GetSection(Constants.DataConfigurationSectionName);
            }
