    ...
    public class GenericDatabase : Database
    {
        ...
        private void LoadConnectionStringSettings(string databaseName)
        {
            ...
            if (connectionStringSetting == null)
                throw new EvaTechnicalException ("", new  System.Configuration.ConfigurationErrorsException(string.Format(Resources.ERROR_CONNECTIONSTRINGSETTINGS_NULL,databaseName)));
        ...
        public override DbCommand GetCommand(string procedureName)
        {
            if (string.IsNullOrEmpty(procedureName))
                throw new EvaTechnicalException ("", new ArgumentException());
        ...
        {
            if (command == null) throw new EvaTechnicalException ("", new  ArgumentNullException("command"));
