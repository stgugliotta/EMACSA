...
using ar.com.telecom.eva.CoreServices.Security.Module;
...
namespace ar.com.telecom.eva.CoreServices.Security.Module
{
    public class EvaModule
    {
        ...
        private void load()
        {
            ...
            {
                throw new EvaTechnicalException("Falla al obtener los datos del modulo.", ex);
            }
        }
        ...
        public ModuleStatus GetModuleCurrentStatus(string sModuleName)
        {
            ...
            if (module_name!="" || (sModuleName!=null && sModuleName!=""))
            {
                ...
                {
                    throw new EvaTechnicalException("Error al obtener recurso", ex);
                }
                finally
                {
        ...
        public void setModuleStatus(ModuleStatus moduleStatus)
        {
            ...
            if (module_name!="" && module_name!=null && moduleStatus!=null && moduleStatus.Idstatus!=null)
            {
                ...
                {
                    throw new EvaTechnicalException("No se ha podido cambiar el estado del modulo.", ex);
                }
                finally
                {
                    if (dr != null && !dr.IsClosed) dr.Close();
            ...
            else
            {
                ...
                {
                    throw new EvaTechnicalException("No se especifica un estado a asignar.", null);
                }
                else
                {
                    throw new EvaTechnicalException("No se indica modulo al cual aplicar el cambio de estado.", null);
                }
