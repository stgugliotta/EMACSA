    ...
    public static class ModuleStatusFactory
    {
        ...
        public static ModuleStatus GetModuleStatus(string moduleStatusName)
        {
            ...
            if (moduleStatusName!="" && moduleStatusName!=null)
            {
                ...
                {
                    throw new EvaTechnicalException("No se ha podido obtener el estado solicitado.", ex);
                }
                finally
                {
            ...
            {
                throw new EvaTechnicalException("No se ha especificado el nombre del estado deseado.", null);
            }
        }
