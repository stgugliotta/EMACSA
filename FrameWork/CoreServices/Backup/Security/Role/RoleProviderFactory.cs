...
using ar.com.telecom.eva.CoreServices.Security.Role.Provider;
using ar.com.telecom.eva.CoreServices.Configuration;
using ar.com.telecom.eva.CoreServices.Properties;
using ar.com.telecom.eva.CoreServices.Security;
    ...
    public static class RoleProviderFactory
    {
        ...
        public static IRoleProvider GetRoleProviderManager(string roleProviderManagerName)
        {
            if (string.IsNullOrEmpty(roleProviderManagerName))
                 throw new EvaTechnicalException ("", new   ArgumentException(Resources.ERROR_EMPTYPARAMETERNAME, "roleProviderManagerName"));
            RoleConfigurationSection roleConfigurationSection = RoleConfigurationSection.GetInstance();
