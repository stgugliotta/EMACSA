...
using ar.com.telecom.eva.CoreServices.ExceptionHandling.Configuration;
...
namespace ar.com.telecom.eva.CoreServices.ExceptionHandling
{
    ...
    /// <see cref="EvaBusinessException"/> y para <see cref="EvaTechnicalException"/> 
    ...
    public static class ExceptionPolicy
    {
        ...
        public static bool HandleException(EvaException exceptionToHandle, string policyName)
        {
            if (policies == null || policies.Count == 0)
                throw new EvaTechnicalException ("", new  ConfigurationErrorsException(Resources.ERROR_EXCEPTIONPOLICY_NOTPOLICIESDEFINED));
            ...
            {
                throw new EvaTechnicalException(string.Format(Resources.ERROR_EXCEPTIONPOLICY_POLICYNOTFOUND, policyName), ex);
            }
