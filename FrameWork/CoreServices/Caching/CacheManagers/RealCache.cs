...
namespace Gobbi.CoreServices.Caching.CacheManagers
{
    ...
    public sealed class RealCache : IDisposable
    {
        ...
        private static void ValidateKey(string key)
        {
            ...
            {
                throw new GobbiTechnicalException("", new  ArgumentException(Resources.ERROR_EMPTYPARAMETERNAME, "key"));
            }
        }
        ...
        private void EnsureCacheInitialized()
        {
            ...
            {
                throw new  GobbiTechnicalException("", new InvalidOperationException(Resources.ERROR_REALCACHE_NOTINITIALIZED));
            }
        }
