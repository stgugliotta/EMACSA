...
namespace Gobbi.CoreServices.Caching.CacheManagers
{
    ...
    public class SQLCacheManager : ICacheManager, IConfigurable
    {
        ...
        public void Configure(ConfigurationElement element)
        {
            ...
            {
                throw new GobbiTechnicalException ("", new ConfigurationErrorsException(string.Format(Resources.ERROR_SQLCACHEMANAGER_NULLPARAMETER, "databaseName")));
            }
            ...
            {
                throw new GobbiTechnicalException ("", new ConfigurationErrorsException(string.Format(Resources.ERROR_SQLCACHEMANAGER_NULLPARAMETER, "databasePartitionName")));
            }
