...
namespace Gobbi.CoreServices.Data
{
    ...
    public abstract class Database
    {
        ...
        public abstract void AddInParameter(DbCommand command, string name, DbType dbType, object value,int scale);
        public abstract void AddInParameterCat(DbCommand command, string name, DbType dbType, object value, int scale);
        ///<summary>
